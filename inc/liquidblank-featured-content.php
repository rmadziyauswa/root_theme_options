 ...
 */
class Liquidblank_Featured_Content {
	 ...
	 *
	 * @see Liquidblank_Featured_Content::init()
	 *
	...
	public static function init() {
		...
		// Return early if "Liquidblank_Featured_Content_filter" has not been defined.
		if ( ! isset( $theme_support[0]['Liquidblank_Featured_Content_filter'] ) ) {
			return;
		}

		$filter = $theme_support[0]['Liquidblank_Featured_Content_filter'];
	 ...
	 *
	 * Sets the "Liquidblank_Featured_Content_ids" transient.
	 *
	 * @static
	 * @access public
	 * @since Liquid Blank 1.0
	...
	public static function get_featured_post_ids() {
		...
		$featured_ids = get_transient( 'Liquidblank_Featured_Content_ids' );
		...
		set_transient( 'Liquidblank_Featured_Content_ids', $featured_ids );
	 ...
	 *
	 * @see Liquidblank_Featured_Content::liquidblank_validate_settings().
	 *
	 * @static
	 * @access public
	 * @since Liquid Blank 1.0
	...
	public static function delete_transient() {
		delete_transient( 'Liquidblank_Featured_Content_ids' );
	}
	 ...
	 * the transient is deleted by Liquidblank_Featured_Content::liquidblank_validate_settings().
	 *
	...
	public static function delete_post_tag( $tag_id ) {
		...
		$settings['tag-id'] = 0;
		$settings = self::liquidblank_validate_settings( $settings );
	 ...
	 *
	 * @uses Liquidblank_Featured_Content::get_setting()
	 */
	...
	public static function register_setting() {
		register_setting( 'featured-content', 'featured-content', array( __CLASS__, 'liquidblank_validate_settings' ) );
	}
	...
	public static function customize_register( $wp_customize ) {
		$wp_customize->add_section( 'Liquidblank_Featured_Content', array(
		...
		$wp_customize->add_setting( 'featured-content[tag-name]', array(
			'default'              => _x( 'featured', 'featured content default tag slug', 'liquidblank' ),
			'type'                 => 'option',
		...
		$wp_customize->add_control( 'featured-content[tag-name]', array(
			'label'    => __( 'Tag Name', 'liquidblank' ),
			'section'  => 'Liquidblank_Featured_Content',
			'priority' => 20,
		) );
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => __( 'Don&rsquo;t display tag on front end.', 'liquidblank' ),
			'section'  => 'Liquidblank_Featured_Content',
			'type'     => 'checkbox',
			'priority' => 30,
		) );
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'liquidblank' ),
		);
	 ...
	 * delete the transient set in Liquidblank_Featured_Content::get_Liquidblank_Featured_Content().
	 *
	 * @static
	 * @access public
	 * @since Liquid Blank 1.0
	 ...
	 */
	public static function liquidblank_validate_settings( $input ) {
		$output = array();
...
} // Liquidblank_Featured_Content

Liquidblank_Featured_Content::setup();
